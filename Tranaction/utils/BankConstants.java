...
public class BankConstants {
    ...
    public static final int JOIN_ACCOUNT_MINIMUM_BALANCE = 50;
    public static final int SAVING_ACCOUNT_MINIMUM_BALANCE = 500;
    public static final int BUSINESS_ACCOUNT_MINIMUM_BALANCE = 5000;
    public static final int JOIN_ACCOUNT_INTEREST = 1;
    public static final int SAVING_ACCOUNT_INTEREST = 5;
    public static final int BUSINESS_ACCOUNT_INTEREST = 0;
    public static final int PROCESSING_AMOUNT = 0;
    public static final int SAVING_PROCESSING_PERCENTAGE = 2;
    public static final int JOIN_PROCESSING_PERCENTAGE = 1;
    public static final int BUSINESS_PROCESSING_PERCENTAGE = 20;
