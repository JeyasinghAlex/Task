...
public class RestSuccess {
	...
	public static Response successResponse(Student data) {
		ResponseBuilder rb = Response.ok(data, MediaType.APPLICATION_JSON);
		return rb.build();
	}

	public static Response sendResponse(List<Student> students) {
	...
	public static Response successResponse(List<List<String>> data) {
		ResponseBuilder rb = Response.ok(data, MediaType.APPLICATION_JSON);
		return rb.build();
	}
