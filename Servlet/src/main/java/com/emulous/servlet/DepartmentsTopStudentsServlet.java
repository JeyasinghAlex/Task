...
public class DepartmentsTopStudentsServlet extends HttpServlet {

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String id = request.getParameter("limits");
		StaffOperationImpl operation = StaffOperationImpl.getInstance();
		List<Student> students = operation.getEachDeptTopStudents(Integer.parseInt(id));
		request.setAttribute("deptTopStudents", students);
